...
const getPlaylist = async function (channel, fromDate, toDate) {
  ...
  songList: [
     ...
     */
    const url = `https://il.srgssr.ch/integrationlayer/2.0/srf/songList/radio/byChannel/${channel}?from=${fromDate}T00%3A00%3A00%2B01%3A00&to=${toDate}T23%3A59%3A00%2B01%3A00&pageSize=500`
